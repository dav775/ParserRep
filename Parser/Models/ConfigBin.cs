...
namespace Parser
{
    //Серрилизуемый класс модели конфигурации для менеджера конфигурац BIN реалиует интерфейсы IConfig и INotifyPropertyChanged
    [Serializable]
    public class ConfigBin : IConfig, INotifyPropertyChanged
    {
